...
Button(root,text='7',height=5,width=10,bd=5,command=lambda:insert(7)).grid(row=1,column=1)
Button(root,text='8',height=5,width=10,bd=5,command=lambda:insert(8)).grid(row=1,column=2)
Button(root,text='9',height=5,width=10,bd=5,command=lambda:insert(9)).grid(row=1,column=3)
...
Button(root,text='1',height=5,width=10,bd=5,command=lambda:insert(1)).grid(row=3,column=1)
Button(root,text='2',height=5,width=10,bd=5,command=lambda:insert(2)).grid(row=3,column=2)
Button(root,text='3',height=5,width=10,bd=5,command=lambda:insert(3)).grid(row=3,column=3)
...
Button(root,text='mod',height=5,width=10,bd=5,command=lambda:insert('%')).grid(row=5,column=4)
Label(root,text='HAPPY CALCULATING').grid(row=8,column=3)
mainloop()
